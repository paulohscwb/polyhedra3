...
<form style="margin: 0 auto; float:right; text-align:right; width:100%; margin-bottom:15px;">
	<select id="url" onchange="urlHandler(this.value)" style="color:royalblue;">
		...
		<option disabled value="../../dragon-archimedes/pt-br/">Fractais do dragão de Arquimedes e Catalan</option>
...
<p id="p1"></p>
  <h2 align="center"><img src="../vr/salas/imagens/icone.png" style="margin-bottom:-10px" width="45"> Fractais do dragão de Arquimedes e Catalan</h2>
...
<br>Este trabalho mostra os poliedros de Arquimedes e Catalan formando fractais de dragão, modelados para visualização em Realidade Virtual.
...
<a href="../vr/dragon13.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/13A.png" class="foto" alt="fractal dragão de Cubo snub"></a>
 ...
 <br>
<hr>
<h4>14. Hexecontaedro deltoidal</h4>
<a href="../vr/catalan1.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/14A.png" class="foto" alt="fractal dragão de Hexecontaedro deltoidal"></a>
 <br>Fractal de dragão do hexecontaedro deltoidal.
 <br>
<hr>
<h4>15. Icositetraedro deltoidal</h4>
<a href="../vr/catalan2.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/15A.png" class="foto" alt="fractal dragão de Icositetraedro deltoidal"></a>
 <br>Fractal de dragão do icositetraedro deltoidal.
 <br>
<hr>
<h4>16. Dodecaedro disdiakis</h4>
<a href="../vr/catalan3.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/16A.png" class="foto" alt="fractal dragão de Dodecaedro disdiakis"></a>
 <br>Fractal de dragão do dodecaedro disdiakis.
 <br>
<hr>
<h4>17. Octaedro triakis</h4>
<a href="../vr/catalan4.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/17A.png" class="foto" alt="fractal dragão de Octaedro triakis"></a>
 <br>Fractal de dragão do octaedro triakis.
 <br>
<hr>
<h4>18. Tetraedro triakis</h4>
<a href="../vr/catalan5.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/18A.png" class="foto" alt="fractal dragão de Tetraedro triakis"></a>
 <br>Fractal de dragão do tetraedro triakis.
 <br>
<hr>
<h4>19. Icosaedro triakis</h4>
<a href="../vr/catalan6.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/19A.png" class="foto" alt="fractal dragão de Icosaedro triakis"></a>
 <br>Fractal de dragão do icosaedro triakis.
 <br>
<hr>
<h4>20. Icositetraedro pentagonal</h4>
<a href="../vr/catalan7.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/20A.png" class="foto" alt="fractal dragão de Icositetraedro pentagonal"></a>
 <br>Fractal de dragão do icositetraedro pentagonal.
 <br>
<hr>
<p class="topop"><a href="#p1" class="topo">voltar ao topo</a></p>
<h4>21. Triacontaedro disdiakis</h4>
<a href="../vr/catalan8.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/21A.png" class="foto" alt="fractal dragão de Triacontaedro disdiakis"></a>
 <br>Fractal de dragão do triacontaedro disdiakis.
 <br>
<hr>
<h4>22. Triacontaedro rômbico</h4>
<a href="../vr/catalan9.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/22A.png" class="foto" alt="fractal dragão de Triacontaedro rômbico"></a>
 <br>Fractal de dragão do triacontaedro rômbico.
 <br>
<hr>
<h4>23. Dodecaedro pentakis</h4>
<a href="../vr/catalan10.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/23A.png" class="foto" alt="fractal dragão de Dodecaedro pentakis"></a>
 <br>Fractal de dragão do dodecaedro pentakis.
 <br>
<hr>
<h4>24. Hexaedro tetrakis</h4>
<a href="../vr/catalan11.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/24A.png" class="foto" alt="fractal dragão de Hexaedro tetrakis"></a>
 <br>Fractal de dragão do hexaedro tetrakis.
 <br>
<hr>
<h4>25. Hexecontaedro pentagonal</h4>
<a href="../vr/catalan12.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/25A.png" class="foto" alt="fractal dragão de hexecontaedro pentagonal"></a>
 <br>Fractal de dragão do hexecontaedro pentagonal.
 <br>
<hr>
<h4>26. Dodecaedro rômbico</h4>
<a href="../vr/catalan13.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/26A.png" class="foto" alt="fractal dragão de Dodecaedro rômbico"></a>
 <br>Fractal de dragão do dodecaedro rômbico.
 <br>
<hr>
<p class="topop"><a href="#p1" class="topo">voltar ao topo</a></p>
...
<p>Siqueira, P.H., "Archimedes and Catalan dragon fractals: polyhedra and visualization with Virtual Reality". Disponível em: <https://paulohscwb.github.io/polyhedra3/dragon-archimedes/pt-br/>, Março de 2025.</p>
